...
public class NaturalNumberTest {
    ...
    private static final Logger LOGGER = Logger.getLogger(NaturalNumber.class.getName());
...
//            LOGGER.info(String.format("%s took %d microseconds", description, TimeUnit.NANOSECONDS.toMillis(nanos)));
